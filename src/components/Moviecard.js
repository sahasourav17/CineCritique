      ...
      <div className="pt -4 flex--movie align-center flex flex-wrap justify-center">
        <div className="m-4 flex w-full max-w-4xl justify-between overflow-hidden rounded shadow-lg md:w-full lg:w-1/2">
          ...
          <div className="bg-color-333 flex flex-grow flex-col px-8 py-4">
            <h3 className="movie--title text-4xl font-bold text-rainblue-100 md:text-2xl lg:text-2xl">
              {data.Title}
            </h3>
            ...
            <div className="flex-grow">
              ...
              <p className="truncate-overflow text-black mb-2 text-xl leading-snug md:text-base lg:text-base">
                {data.Actors}
              </p>
              <p className="truncate-overflow text-black mb-2 text-xl leading-snug md:text-base lg:text-base">
                {data.Plot}
            ...
            <div className="button-container mb-2 flex justify-between">
              <button className="text-medium rounded bg-rainblue-50 py-2 px-4 font-semibold text-white lg:text-sm">
                More Info
              </button>
              <button className="text-medium rounded bg-rainblue-50 py-2 px-4 font-semibold text-white lg:text-sm">
                Review Movie
